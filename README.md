...
| **Social Gameplay** | 🟢 | 🟡 | Most fellowship interactions supported + tracking HUD. Allegiance still TODO. |
...
- Release archives already include the micro `portal.hba` needed for the current runtime path, including the motion tables and animations required for self movement.
