...
pub mod object_resource_closure;
pub mod object_texture;
pub mod outdoor_static_source;
...
pub struct LoadLandblockSourceBatchRequest {
    pub landblock_id: String,
    pub layers: Vec<LandblockSourceLayer>,
}

#[derive(Debug, Clone, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct LoadLandblockProfileRequest {
    pub landblock_id: String,
}
...
pub struct LoadTexturePixelsRequest {
    ...
    #[serde(default)]
    pub palette_composite: Option<LoadPaletteCompositeRequest>,
}

#[derive(Debug, Clone, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct LoadPaletteCompositeRequest {
    pub base_palette_id: String,
    pub ranges: Vec<LoadPaletteRangeRequest>,
}

#[derive(Debug, Clone, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct LoadPaletteRangeRequest {
    pub replacement_palette_id: String,
    pub offset: u32,
    pub color_count: u32,
}
...
#[derive(Debug, Clone, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct LoadAnimationRequest {
...
#[derive(Debug, Clone, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct LoadParticleEmitterRequest {
    pub emitter_info_id: String,
}

#[derive(Debug, Clone, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct LoadAudioRequest {
    pub sound_id: String,
}

#[derive(Debug, Clone, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct LoadSoundTableRequest {
    pub sound_table_id: String,
}

#[derive(Debug, Clone, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct LoadParticleMeshesRequest {
    pub hw_gfx_obj_ids: Vec<String>,
}
...
#[serde(rename_all = "camelCase")]
pub struct ExplorerEntityMutationReceipt {
...
#[serde(rename_all = "camelCase")]
pub struct ReplaceExplorerEntityPhysicsStateRequest {
...
#[derive(Debug, Clone, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct MotionTableClosureRequest {
    pub motion_table_id: String,
}

/// Host identity and readiness state returned by the status command.
...
/// Builds the canonical profile response used by the sidecar and development HTTP host.
...
/// Build the canonical active-region response used by the sidecar and headless browser harness.
...
/// Build the canonical texture-pixel response used by the sidecar and headless browser harness.
///
...
///
/// Shared by the sidecar command and dev content host so the browser harness stages the same
...
/// Build the canonical typed animation response used by the sidecar and focused host tests.
...
/// Build the canonical typed physics-script response used by the sidecar and focused host tests.
...
/// Build the canonical typed audio response used by the sidecar and focused host tests.
...
/// Build the canonical typed sound-table response used by the sidecar and focused host tests.
...
/// Build the canonical typed particle-mesh response used by the sidecar and focused host tests.
