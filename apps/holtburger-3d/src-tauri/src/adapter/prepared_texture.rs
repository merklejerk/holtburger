...
fn validate_compressed_source(render_surface: &RenderSurface) -> Result<()> {
...
fn decode_dxt_surface_downsampled_2x(render_surface: &RenderSurface) -> Result<Vec<Rgba>> {
...
fn downsample_rgba_2x(source: &[Rgba], source_width: u32, source_height: u32) -> Result<Vec<Rgba>> {
