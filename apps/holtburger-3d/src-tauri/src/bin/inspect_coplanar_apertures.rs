...
use holtburger_3d::cell_struct_projection::{
    CellStructProjection, CellStructProjectionContext, project_cell_struct,
};
use holtburger_3d::discover_content_runtime;
use holtburger_3d::gfx_obj_geometry::build_gfx_obj_portal_apertures;
use holtburger_3d::interior_seam::{
    IndoorSeamClassification, IndoorSeamEvidence, classify_indoor_seam,
};
use holtburger_3d::polygon_geometry::RenderVec3;
use holtburger_3d::portal_geometry::accepted_plane_side;
use holtburger_3d::portal_geometry::{PortalAperture, transform_aperture};
use holtburger_3d::portal_visibility::apertures_form_junction;
