...
use holtburger_3d::interior_seam::{IndoorSeamEvidence, classify_indoor_seam};
use holtburger_3d::portal_geometry::{
...
use holtburger_3d::portal_visibility::intersect_visibility_apertures;
...
fn main() -> Result<()> {
    ...
    for env_cell_id in SELECTED_ENV_CELLS {
        ...
        let render_center = transform_render_point(
            holtburger_3d::polygon_geometry::RenderVec3 {
...
fn aperture_center(
    aperture: &holtburger_3d::portal_geometry::PortalAperture,
) -> holtburger_3d::polygon_geometry::RenderVec3 {
