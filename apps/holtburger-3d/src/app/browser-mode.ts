...
export function parseBrowserLocationInput(
  ...
  const [, northSouth, northSouthHemisphere, eastWest, eastWestHemisphere, elevation] = match;
...
export function previewBrowserLocation(browserMode: BrowserModeState): BrowserModeState {
