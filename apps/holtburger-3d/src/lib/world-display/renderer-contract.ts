...
interface WorldRenderDebugMetrics {
	...
	staticBundleSelectedLayerCoverageSamples: string[];
	...
	materialSurfaceSubmittedCountsByDomain: Record<string, number>;
	materialSurfaceDrawCallCountsByDomain: Record<string, number>;
	materialSurfaceTriangleCountsByDomain: Record<string, number>;
	materialSurfaceSkippedCount: number;
	materialSurfaceSkippedCountsByDomain: Record<string, number>;
	...
	materialSurfaceSubmitFallbackSamples: string[];
