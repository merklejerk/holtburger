<script lang="ts">
	...
	const rendererDiagnosticsText = $derived.by(() => {
		...
		return `Perf ${performanceText}. Diagnosis: ${diagnosis}. Draw pressure ${debug.renderCalls} visible draws from ${candidateBatchCount} candidate ${drawGroupTerm}; static candidates ${debug.staticBvhCandidateBatchCount}${staticCandidateRatio}; retained ${drawGroupTerm} terrain ${debug.terrainRenderBatchCount}, static ${debug.staticRenderBatchCount}, interiors ${debug.structuredInteriorRenderBatchCount}; retained tris ${debug.renderTriangles}. Material path ${debug.materialCount} materials, ${debug.textureResourceCount} textures, ${debug.indexedTextureResourceCount} indexed textures, ${debug.paletteResourceCount} palettes, direct/material types ${materialTypes}; atlas candidates ${debug.atlasEligibleMaterialCount} draws, ${debug.atlasCandidateEntryCount} entries, ${debug.atlasCandidateMaterialSlotCount} material slots; atlas static compactable ${debug.atlasStaticCompactableDrawUnitCount}, generation textures ${debug.atlasStaticGenerationTextureCount}, compacted batches ${debug.atlasStaticCompactedBatchCount}, compacted draws ${debug.atlasStaticCompactedDrawUnitCount}, compacted slices ${debug.atlasStaticCompactedDrawSliceCount}, batch origins ${debug.atlasStaticBatchOriginCount}, transform table entries ${debug.atlasStaticTransformTableEntryCount}, compacted bytes ${debug.atlasStaticCompactedTotalByteLength}, shader draws ${debug.atlasStaticShaderDrawCallCount}, submitted batches ${debug.atlasStaticSubmittedBatchCount}, submitted slices ${debug.atlasStaticSubmittedDrawSliceCount}, represented slice draws ${debug.atlasStaticSubmittedSliceRepresentedDrawUnitCount}, replaced ${debug.atlasStaticReplacedDrawUnitCount}, retained ${debug.atlasStaticRetainedDrawUnitCount}, atlas draw-call math ${debug.atlasStaticOriginalDrawCallEstimateCount}-${debug.atlasStaticReplacedDrawUnitCount}+${debug.atlasStaticShaderDrawCallCount}=${debug.atlasStaticSubmittedDrawCallEstimateCount} saved ${debug.atlasStaticDrawCallSavingsCount}, atlas tris replaced/submitted ${debug.atlasStaticReplacedDrawUnitTriangleCount}/${debug.atlasStaticSubmittedTriangleCount}, conservative overdraw ${debug.atlasStaticConservativeOverdrawTriangleCount} tris (${debug.atlasStaticConservativeOverdrawRatio.toFixed(2)}), no-visible routes ${debug.atlasStaticSubmitNoVisibleRouteCount} (exterior ${debug.atlasStaticSubmitNoVisibleExteriorRouteCount}, interior ${debug.atlasStaticSubmitNoVisibleInteriorRouteCount}, other ${debug.atlasStaticSubmitNoVisibleOtherRouteCount}), bypasses ${debug.atlasStaticCompactionBypassReasonCount}${atlasCompactionBypassSamples ? ` (${atlasCompactionBypassSamples})` : ""}${atlasResourceFallbackSamples ? `, resource fallbacks ${atlasResourceFallbackSamples}` : ""}${atlasSubmitFallbackSamples ? `, submit fallbacks ${atlasSubmitFallbackSamples}` : ""}; fallbacks ${debug.fallbackReasonCount}${fallbackSamples ? ` (${fallbackSamples})` : ""}. Policy ${debug.renderGraphPolicy}, base ${debug.renderGraphBaseScene}, transition depth ${debug.transitionPortalMaxDepth}; canvas ${debug.canvasWidth}x${debug.canvasHeight} @${debug.pixelRatio.toFixed(2)}.`;
	});
