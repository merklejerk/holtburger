<script lang="ts">
	...
	const rendererDiagnosticsText = $derived.by(() => {
		...
		const atlasWorkerText = `Atlas workers: texture schedulers ${debug.textureAtlasWorkerActiveSchedulerCount}, jobs submitted ${debug.textureAtlasWorkerSubmittedJobCount}, deduped ${debug.textureAtlasWorkerDedupedDesiredJobCount}, coalesced ${debug.textureAtlasWorkerCoalescedDesiredJobCount}, stale ${debug.textureAtlasWorkerStaleResultCount}, ready ${debug.textureAtlasWorkerReadyResultCount}, committed ${debug.textureAtlasWorkerCommittedResultCount}, errors ${debug.textureAtlasWorkerErrorCount}; indexed schedulers ${debug.indexedResourceAtlasWorkerActiveSchedulerCount}, jobs submitted ${debug.indexedResourceAtlasWorkerSubmittedJobCount}, deduped ${debug.indexedResourceAtlasWorkerDedupedDesiredJobCount}, coalesced ${debug.indexedResourceAtlasWorkerCoalescedDesiredJobCount}, stale ${debug.indexedResourceAtlasWorkerStaleResultCount}, ready ${debug.indexedResourceAtlasWorkerReadyResultCount}, committed ${debug.indexedResourceAtlasWorkerCommittedResultCount}, errors ${debug.indexedResourceAtlasWorkerErrorCount}`;
