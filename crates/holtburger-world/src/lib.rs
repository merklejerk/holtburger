...
pub use spatial::{
    AuthoritativeBodyKinematics, AuthoritativeBodySync, CellTransitRequest, ChildSpatialBody,
    ChildSpatialBodyDefinition, ChildSpatialBodyDefinitionError, ChildSpatialBodyWaypoint,
    ...
    DynamicBodyPhysicsStateChange, DynamicBodyRelocationOutcome, DynamicPhysicalBodyDefinition,
    EdgeProtection, FreeSphereBudget, FreeSphereConfig, FreeSphereOutcome, FreeSphereRequest,
    ...
    SpatialMembership, SpatialSampleMode, SpatialSamplingConfig, SpatialSamplingState,
    SpatialScene, SphereSweep, StaticContact, StaticSphereSweepHit, StaticSphereSweepRequest,
    SupportContact, SupportFeature, SupportRequest, advance_authored_body_kinematics,
    advance_body_kinematics, gate_authored_offset, physical_body_scene_residency,
    project_pose_forward_distance, resolve_physical_body_cell, settle_free_sphere,
