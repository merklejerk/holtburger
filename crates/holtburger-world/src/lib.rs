...
pub use spatial::{
    ...
    DynamicPhysicalBodyDefinition, EdgeProtection, FreeSphereBudget, FreeSphereConfig,
    FreeSphereOutcome, FreeSphereRequest, FreeSphereState, GroundState, GroundSupport,
    GroundedBody, GroundedBodyActuation, GroundedBodySpheres, GroundedBudget, GroundedConfig,
    GroundedLaunch, GroundedObstruction, GroundedObstructionRequest, GroundedOutcome,
    GroundedRequest, GroundedSphere, LocalDriveControl, LocalDriveGait,
    MAXIMUM_DYNAMIC_SLICE_DISTANCE, MAXIMUM_DYNAMIC_SLICES, MotionWaypoint,
    MotionWaypointPlacement, MovementObstructionRequest, MovementRestrictionRequest,
    NoopSpatialPhysics, PhysicalBodyActuation, PhysicalBodyActuationError, PhysicalBodyDefinition,
    ...
    PhysicalSphereSet, PhysicalSurfaceMotion, PlacedMotionLeg, PlacedMotionPath,
    PlacedMotionPathRequest, PlacedMotionPoint, PlacementRecovery, PlacementRequest,
    PlacementRestrictionRequest, PreparedEntityBspPart, PreparedEntityTargetGeometry,
