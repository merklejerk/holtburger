...
pub use spatial::{
    ...
    LocalDriveControl, LocalDriveGait, MissingCoverage, MotionWaypoint, MovementObstructionRequest,
    NoopSpatialPhysics, PhysicalBodyActivity, PhysicalBodyDefinition, PhysicalBodyDefinitionError,
    PhysicalBodyMotion, PhysicalBodyResponseState, PhysicalBodyState, PhysicalBodyTickOutcome,
    ...
    PlacedMotionPath, PlacedMotionPathRequest, PlacedMotionPoint, PlacementRequest,
