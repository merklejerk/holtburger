...
pub use spatial::{
    ...
    MotionWaypoint, MotionWaypointPlacement, MovementObstructionRequest, NoopSpatialPhysics,
    PhysicalBodyActivity, PhysicalBodyActuation, PhysicalBodyActuationError,
    ...
    PhysicalBodyState, PhysicalBodyTickOutcome, PhysicalBodyTickResult, PhysicalBodyTickStatus,
