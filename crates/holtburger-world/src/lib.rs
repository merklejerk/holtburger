...
pub use spatial::{
    ...
    CollisionOwnerProof, CollisionQueryError, CollisionQueryPolicy, CollisionReportClassification,
    ...
    SpatialEntitySample, SpatialMembership, SpatialSampleMode, SpatialSamplingConfig,
    SpatialSamplingState, SpatialScene, SphereSweep, StaticContact, StaticSphereSweepHit,
    StaticSphereSweepRequest, SupportContact, SupportFeature, SupportRequest,
    UncoveredCollisionQuery, advance_authored_body_kinematics, advance_body_kinematics,
    gate_authored_offset, physical_body_scene_residency, project_pose_forward_distance,
    resolve_physical_body_cell, settle_free_sphere, settle_free_sphere_with_policy,
