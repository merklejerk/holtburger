...
pub use spatial::{
    ...
    FreeSphereConfig, FreeSphereOutcome, FreeSphereRequest, FreeSphereSettleConfig,
    FreeSphereSettleOutcome, FreeSphereState, GroundState, GroundSupport, GroundedBody,
    GroundedBodyActuation, GroundedBodySpheres, GroundedBudget, GroundedConfig,
    GroundedContactState, GroundedLaunch, GroundedObstruction, GroundedObstructionRequest,
    GroundedOutcome, GroundedRequest, GroundedSphere, HardEntityShape, HardSphereSweep,
    HardSphereSweepHit, LocalDriveControl, LocalDriveGait, MOBILE_CONTACT_ANGULAR_CHORDS,
    MOBILE_CONTACT_CORRECTION_FRACTION, MOBILE_CONTACT_CORRECTION_TRAVEL_RADIUS_RATIO,
    MOBILE_CONTACT_HARD_SLIDE_PASSES, MOBILE_CONTACT_PASSES, MOBILE_CONTACT_TICK_SECONDS,
    MOBILE_CONTACT_TOLERANCE_METERS, MOBILE_CONTACT_TOLERANCE_RADIUS_RATIO, MobileContactBody,
    MobileContactChange, MobileContactResponse, MotionWaypoint, MotionWaypointPlacement,
    MovementObstructionRequest, MovementRestrictionRequest, PASSIVE_MOTOR_ACCELERATION,
    PASSIVE_MOTOR_BRAKING, PHYSICAL_RETURN_GAIN, PhysicalBodyActuation, PhysicalBodyActuationError,
