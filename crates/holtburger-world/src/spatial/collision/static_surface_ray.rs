...
fn validate_ray(request: StaticSurfaceRayRequest) -> Result<(), CollisionQueryError> {
...
fn ray_sweep(request: StaticSurfaceRayRequest, end: Vector3) -> SphereSweep {
    SphereSweep {
        anchor: request.anchor,
        start: request.start,
        end,
