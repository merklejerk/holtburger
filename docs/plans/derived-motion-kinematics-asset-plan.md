...
- [crates/holtburger-core/src/client/builder.rs](/home/cluracan/code/holtburger/crates/holtburger-core/src/client/builder.rs) for the required-asset constant and validation hookup
...
- Measure the output-size delta and record it in the plan or follow-up verification notes.
...
- The bundle-size reduction is measured rather than assumed.
...
### Task Checklist
- [ ] Phase 1: Define derived asset schema, constants, and typed lookup API.
- [ ] Phase 2: Emit derived motion kinematics and setup defaults from `dat2hba`.
- [ ] Phase 3: Switch world lookup to required derived-asset resolution and validation.
- [ ] Phase 4: Recut the micro profile and verify archive contents and size.
- [ ] Phase 5: Audit and document observer-projection readiness.
...
### Open Questions
- What constant file id should we reserve for the required motion-kinematics asset within `holtburger/core`?